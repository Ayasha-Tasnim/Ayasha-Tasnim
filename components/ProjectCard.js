  ...
  return (
    ...
    >
      <div className="relative h-48 w-full overflow-hidden bg-slate-900">
        ...
        {imageError || !image ? (
          <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-[#0B1023] via-[#050816] to-[#7C3AED]/20">
            <Sparkles className="w-10 h-10 text-purple-400 animate-pulse mb-2" />
