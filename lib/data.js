...
export const personalInfo = {
  ...
  resumeUrl: '#',
  socials: {
    github: 'https://github.com/Ayasha-Tasnim',
    linkedin: 'https://www.linkedin.com/in/ayasha-tasnim/',
    facebook: 'https://www.facebook.com/share/1EvFMwZsSf/',
...
export const projects = [
  {
    title: 'Tech Wave',
    description:
      'A visually engaging podcast website designed with modern layouts, vibrant UI elements and responsive frontend implementation.',
    tech: ['HTML5', 'CSS3', 'JavaScript', 'UI/UX'],
    liveLink: 'https://ayasha-tasnim.github.io/Tech-Wave/',
    githubLink: 'https://github.com/Ayasha-Tasnim/Tech-Wave',
...

  {
    ...
    description:
      'A modern knowledge management landing page designed with clean layouts, structured content presentation and an intuitive user experience.',
    tech: ['HTML5', 'CSS3', 'UI/UX'],
    liveLink: 'https://ayasha-tasnim.github.io/Assignment-1/',
    githubLink: 'https://github.com/Ayasha-Tasnim/Assignment-1',
...

  {
    title: 'Rentora',
    description:
      'A modern car rental platform interface featuring clean layouts, responsive design and a smooth user experience.',
    tech: ['React.js', 'Tailwind CSS', 'UI/UX'],
    liveLink: 'https://rentora-jade.vercel.app',
    githubLink: 'https://github.com/Ayasha-Tasnim/Rentora',
...
export const education = [
...

  {
    ...
    institution: 'Science Group, Ispahani Cantonment Public School & College',
    Session: '2020 - 2021',
    description:
